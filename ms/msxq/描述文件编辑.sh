#!/bin/sh
标题
perl -p -i -e "s/852359/KillX「快速关闭所有后台」/g"  cydia副本 sileo副本.json
#描述
perl -p -i -e "s/852360/开启后台卡片切换界面向下拉清理所有后台程序./g"  cydia副本 sileo副本.json
#支持系统
perl -p -i -e "s/852362/IOS:11-12/g"  cydia副本 sileo副本.json
#更新时间
perl -p -i -e "s/2019-01-21/2019-05-02/g"  sileo副本.json
